...
```{r}
tripdata <- read_csv("/cloud/project/202203-divvy-tripdata.csv")
```
...
* total rows in dataset is 284042

#### ride_id

* no missing data
* every row is unique (no duplicates) with 284042 id's
...
* no missing data
* datetime value
* all dates are after 2022-03-01

#### ended_at

* no missing data
* datetime value
* there are dates up to 2022-04-01

#### start_station_name

* there are 47246 missing values
* 843 unique stations
...
* there are 51157 missing values
* 834 unique stations
...
```
* 68,059 records with missing data
...
```
* there are 12 rows here where the trip duration is a negative value or equal to 0
